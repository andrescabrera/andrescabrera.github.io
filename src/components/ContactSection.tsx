...
const SOCIAL_LINKS = [
  ...
  },
  {
    ...
    href: 'https://www.upwork.com/freelancers/~0142a6acf7665542e5?mp_source=share',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  {
    id: 'contact-onstrider',
    label: 'onStrider',
    handle: 'Talent referral',
    href: 'https://app.onstrider.com/r/andres_mcmjbt',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    id: 'contact-github',
    label: 'GitHub',
    handle: '@andrescabrera',
    href: 'https://github.com/andrescabrera',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    id: 'contact-github-alt',
    label: 'GitHub alt',
    handle: '@andrescabrera-esportunity',
